  ...
  proficiency: {
    Navigator: [
      ...
      },
      {
        ...
        howToSteps: [
          ...
          "Group related tabs by right-clicking a tab and choosing \"Add tab to new group\".",
          "Bookmark a page you'll need again with Ctrl/Cmd+D, and save it into a named bookmarks folder.",
    ...
    Elevator: [
      ...
      },
      {
        ...
        howToSteps: [
          "Open the Chrome Web Store and search for a task you repeat often (e.g. grammar checking, screen recording).",
  ...
  literacy: {
    Navigator: [
      {
        ...
        howToSteps: [
          ...
          "Use Google's Tools > Any time filter to find recently published, up-to-date material.",
        ],
    ...
    Elevator: [
      ...
      },
      {
        ...
        howToSteps: [
          "Search using a filter for reusable content, e.g. Google Images > Tools > Usage rights.",
    ...
    Catalyst: [
      ...
      },
      {
        ...
        howToSteps: [
          ...
          "Create a shared Drive folder where colleagues can drop reusable images/media they've found and cleared.",
          "Pin the one-pager and folder link in the team's Space or shared Drive homepage.",
  ...
  learning: {
    Navigator: [
      ...
      },
      {
        ...
        howToSteps: [
          "Search for the specific task, e.g. \"how to add conditional logic in Google Forms\", not just the tool name.",
    ...
    Elevator: [
      ...
      },
      {
        ...
        howToSteps: [
          ...
          "Use the same professional photo across your Google Workspace and LinkedIn profiles.",
